from anyposts.models import User, Post
from anyposts import app, db, bcrypt
from PIL import Image
import secrets
import os
from anyposts.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash(f'Login unsuccessful, please check the details you entered!', 'danger')
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(post)
        db.session.commit()
        flash(f"Post was submited!", 'success')
        return redirect(url_for('home'))
